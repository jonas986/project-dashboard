...
export function AddProjectCard({ onClick }: AddProjectCardProps) {
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-[20px] overflow-hidden border-2 border-dashed border-red-bg-alt flex items-center justify-center min-h-[320px] cursor-pointer transition-all duration-200 hover:border-vodafone-red hover:-translate-y-0.5 hover:shadow-card group"
    >
