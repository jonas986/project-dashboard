    ...
    <div className="bg-white rounded-[20px] overflow-hidden shadow-card border border-black/[0.04]">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-2 mb-5">
          <div className="w-[30px] h-[30px] rounded-full bg-gray-200 animate-skeleton-pulse" />
        ...
        <div className="h-3 w-16 bg-gray-200 rounded animate-skeleton-pulse mt-2" />
        <div className="h-2.5 w-24 bg-gray-200 rounded animate-skeleton-pulse mt-2" />
      </div>
    </div>
  );
}
